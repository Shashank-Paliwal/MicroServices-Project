...
// Testcontainers for Java is a Java library that supports JUnit tests,
...
// tests like: Data access layer integration tests, Application integration tests, UI/Acceptance tests and more.
